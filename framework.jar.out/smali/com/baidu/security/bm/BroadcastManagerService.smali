...
.method private getSystemProtectedBroadcasts()Ljava/util/HashSet;
    ...
    :try_start_0
    const-string v6, "mProtectedBroadcasts"
...
.method public static filterBroadcastReceiver(Ljava/util/List;Ljava/util/List;Landroid/content/Intent;Ljava/util/ArrayList;I)I
    .locals 6
    .parameter "declaredReceivers"
    .parameter "registeredReceivers"
    .parameter "intent"
...
.method public static filterService(Ljava/lang/String;Ljava/util/ArrayList;I)I
    .locals 11
    .parameter "pkg"
    .parameter "runningAppProcesses"
    ...
    .local v6, retVal:I
    sget-boolean v10, Lcom/baidu/security/bm/BroadcastManagerService;->enabled:Z
    ...
    .local v7, silentList:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    if-nez v0, :cond_5
    ...
    .end local v0           #blackList:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    .end local v7           #silentList:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    :cond_4
    sget-object v10, Lcom/baidu/security/bm/BroadcastManagerService;->mService:Lcom/baidu/security/bm/BroadcastManagerService;
    ...
    .restart local v0       #blackList:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    .restart local v7       #silentList:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    :cond_5
    ...
    invoke-virtual {v10, p0, p2}, Lcom/baidu/security/bm/BroadcastManagerService;->isSamePkg(Ljava/lang/String;I)Z
    ...
    .local v4, it:Ljava/util/Iterator;
    sget-object v9, Lcom/baidu/security/bm/BroadcastManagerService;->mService:Lcom/baidu/security/bm/BroadcastManagerService;

    invoke-virtual {v9, p0}, Lcom/baidu/security/bm/BroadcastManagerService;->packageInBlackList(Ljava/lang/String;)Z

    move-result v2

    const/4 v3, 0x0

    .local v3, foundSilent:Z
    if-eqz v7, :cond_8
    ...
    .local v8, silentListItem:Ljava/lang/String;
    :cond_7
    invoke-interface {v4}, Ljava/util/Iterator;->hasNext()Z
    ...
    .end local v8           #silentListItem:Ljava/lang/String;
    check-cast v8, Ljava/lang/String;

    .restart local v8       #silentListItem:Ljava/lang/String;
    ...
    :cond_9
    invoke-static {p0, p1}, Lcom/baidu/security/bm/BroadcastManagerService;->isRunningApp(Ljava/lang/String;Ljava/util/ArrayList;)Z
    ...
    iget-object v9, v9, Lcom/baidu/security/bm/BroadcastManagerService;->mHandler:Lcom/baidu/security/bm/BroadcastManagerService$BlacklistHandler;
    ...
    invoke-virtual {v9, v10, p0}, Lcom/baidu/security/bm/BroadcastManagerService$BlacklistHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v9, v5}, Lcom/baidu/security/bm/BroadcastManagerService$BlacklistHandler;->sendMessage(Landroid/os/Message;)Z

    goto :goto_1
.end method

.method isSamePkg(Ljava/lang/String;I)Z
    .locals 6
    .parameter "pkg"
    .parameter "uid"

    .prologue
    iget-object v5, p0, Lcom/baidu/security/bm/BroadcastManagerService;->mPm:Landroid/content/pm/PackageManager;
