...
#-----------------------------------------------------------------------------
vendor_remove_dirs := etc/channel_files etc/voicecommand app etc/female etc/localTheme01
...
#-----------------------------------------------------------------------------
vendor_remove_files := etc/female.btp etc/localTheme01.btp
...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth Stk1 StkSelection BaiduFM
...
#-----------------------------------------------------------------------------
vendor_modify_apps := SchedulePowerOnOff
...
#-----------------------------------------------------------------------------
baidu_modify_apps := Phone Settings BaiduTheme HomePro
...
override_property += \
    romzj.rom.id=f8d97a9b-7cb0-b293-cc2d-36ef141bdcfa \
    romzj.rom.version=baidurom67 \
    romzj.rom.version.code=1 \
