...
.method public static getPreferredDataSlot(Landroid/content/Context;)I
    ...
    const-string v5, "gprs_connection_prefer_sim_setting"
    ...
    .line 968
    .local v1, preDataSimId:J
    invoke-static {p0, v1, v2}, Landroid/telephony/BaiduTelephonyUtils$SIMInfo;->getSlotById(Landroid/content/Context;J)I

    move-result v3

    .line 969
    .local v3, preDataSlotId:I
    ...
    invoke-virtual {v0, v3}, Landroid/telephony/BaiduTelephonyManager;->getSimState(I)I
    ...
    invoke-virtual {v0, v4}, Landroid/telephony/BaiduTelephonyManager;->getSimState(I)I
