...
.method public static setDefaultNameForNewSim(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    rsub-int/lit8 v10, p2, 0x1

    .line 576
    .local v10, otherSlot:I
    const/4 v9, 0x0

    .line 577
    .local v9, otherSimInfo:Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;
    if-ltz p2, :cond_1

    .line 578
    invoke-static {p0, v10}, Lcom/mediatek/telephony/SimInfoManager;->getSimInfoBySlot(Landroid/content/Context;I)Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;
    ...
    .line 584
    iget v0, v12, Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;->mNameSource:I

    int-to-long v7, v0

    .line 585
    .local v7, oriNameSource:J
    iget-object v11, v12, Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;->mDisplayName:Ljava/lang/String;

    .line 586
    .local v11, simDisplayName:Ljava/lang/String;
    ...
    .line 590
    iget-object v0, v9, Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;->mDisplayName:Ljava/lang/String;
    ...
    .line 592
    .local v6, defaultName:Ljava/lang/StringBuilder;
    if-nez p2, :cond_7
    ...
    .line 602
    .end local v6           #defaultName:Ljava/lang/StringBuilder;
    :cond_3
    if-eqz v11, :cond_5
    ...
    .line 609
    .end local v7           #oriNameSource:J
    .end local v11           #simDisplayName:Ljava/lang/String;
    :cond_6
    return-void

    .line 594
    .restart local v6       #defaultName:Ljava/lang/StringBuilder;
    .restart local v7       #oriNameSource:J
    .restart local v11       #simDisplayName:Ljava/lang/String;
    :cond_7
    const/4 v0, 0x1
